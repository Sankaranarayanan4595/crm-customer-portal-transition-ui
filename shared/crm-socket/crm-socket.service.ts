...
export class CrmSocketService extends Socket {
  ...
  constructor() {
    ...
    this.ioSocket.on("connect", () => {
      console.log("%c✅ CRM Socket Connected", "color: green");
    });
    ...
    this.ioSocket.on("connect_error", (err: any) => {
      console.error("❌ CRM Socket Connection Error:", err);
    });
  }
}